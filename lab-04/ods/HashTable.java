...
public class HashTable<T> extends AbstractCollection<T> {
	...
	protected final int hash(Object x) {
		...
		System.out.println("hashing " + x);
		System.out.println( "z = " + z);
		System.out.println( "w-d = " + (w-d));
		System.out.println( "integer mult: " + (x.hashCode() * z));
		System.out.println( "integer after bit shift: " + ((x.hashCode() * z) >>> (w-d)));
		System.out.println( "long mult: " + ((long)x.hashCode() * z));
		System.out.println( "long after bit shift: " + (((long)x.hashCode() * z) >>> (w-d)));
