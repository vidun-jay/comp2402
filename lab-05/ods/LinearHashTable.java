...
public class LinearHashTable<T> implements USet<T> {
	...
	/**
	 * 
	 * @param nil an object of class T that will never be 
	 * stored in the table
	 */
	...
	/**
	 * Resize the backing array to have size 2^d
	 * Warning: 2^d should be much bigger than n
	 * @param d
	 */
	@SuppressWarnings("unchecked")
	...
	public Iterator<T> iterator() {
		class IT implements Iterator<T> {
			...
			public IT() {
				iprev = -1;
				i = 0;
				while (i < t.length && (t[i] == null || t[i] == del)) i++;
			}
