 ...
 *      % java comp2402w23l5.Part3 <x-value> <input.txt> <output.txt>
 *  will take input from <input.txt> and will print to <output.txt>, or
 *      % java comp2402w23l5.Part3 <x-value> <input.txt>
 *  will take input from <input.txt> and will print to the terminal, or
 *      % java comp2402w23l5.Part3 <x-value>
 ...
 *      % python3 run_local_tests.py student_config_lab5p3.json
